...
class TestEmptyStats:
    def test_none_episode_stats(self):
        s = SimSurvivor(
            id=1, name="Test", voted_out_order=0, made_jury=False, episode_stats=None
        )
    ...
    def test_empty_episode_stats(self):
        s = SimSurvivor(
            id=1, name="Test", voted_out_order=0, made_jury=False, episode_stats={}
        )
        events, badges = generate_highlights(s, make_season(), None)
        assert events == []
        assert badges == []
...
class TestTerminalEvents:
    ...
    def test_fire_making_win(self):
        ...
        season = make_season(
            num_players=18, n_finalists=3, survivors=[winner, fire_loser]
        )
    ...
    def test_fire_making_loser(self):
        ...
        season = make_season(num_players=18, n_finalists=3, survivors=[fire_loser])
